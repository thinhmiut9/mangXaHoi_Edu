...
export const usersApi = {
  ...
  updateProfile: (data: { displayName?: string; interests?: string; avatar?: string; coverPhoto?: string; location?: string; school?: string; major?: string; cohort?: string; profileVisibility?: 'PUBLIC' | 'PRIVATE' }) =>
